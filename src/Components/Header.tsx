...
const Header : FC<IHeaderProps> = ({width, active, isLoggedIn, setCustIsLoggedIn }) => {
  ...
  return (
    ...
    <Register togglePanel={togglePanel} isOpen={isOpen} setCustIsLoggedIn={setCustIsLoggedIn} />
